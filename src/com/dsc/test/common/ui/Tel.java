...
/**
 * A html5 added control for entering a telephone number. Line-breaks are
 * automatically removed from the input value, but no other syntax is enforced.
 ...
 * @Since 1.0
 */
public class Tel extends ButtonBase
{
	public Tel(Context<?, ?> context, String id)
	{
	 ...
	 * @param wrapee
	 */
	public Tel(Context<?, ?> context, WebElement wrapee)
	{
